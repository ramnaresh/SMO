...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''<summary>
        '''  Looks up a localized string similar to Verify Backup - .
        '''</summary>
        ...
        '''<summary>
        '''  Looks up a localized string similar to Verified result: {0}.
        '''</summary>
        Friend ReadOnly Property VerifiedResult() As String
            Get
                Return ResourceManager.GetString("VerifiedResult", resourceCulture)
            End Get
        End Property
    End Module
End Namespace
